#!/usr/bin/env bash
# =========================================================
# NVM PANEL V4 ULTRA INSTALLER (Fully Obfuscated)
# =========================================================
set -euo pipefail

# ---------------------------------------------------------
# Obfuscation layer: base64 encoded strings and evals
# ---------------------------------------------------------
_0x01() { printf '%b' "$(echo "$1" | base64 -d 2>/dev/null)"; }
_0x02() { eval "$(_0x01 "$1")"; }
_0x03() { echo "$(_0x01 "$1")"; }

# Encoded commands and data
...
# Clear and show ASCII (fully obfuscated)
clear
...
# Install deps (obfuscated)
eval "$_CMD_DEPS"
line

# Port check (obfuscated)
eval "$_CMD_PORT"
line

# Create install dir (obfuscated)
eval "$_CMD_DIR"
line

# Download binary (obfuscated)
eval "$_CMD_DOWNLOAD"
line

# Verify binary (obfuscated)
eval "$_CMD_VERIFY"
line
